...
if(TARGET LZ4::lz4_static)
    set(BITCOINII_LZ4_TARGET LZ4::lz4_static)
elseif(TARGET LZ4::lz4_shared)
    set(BITCOINII_LZ4_TARGET LZ4::lz4_shared)
elseif(TARGET lz4::lz4)
    set(BITCOINII_LZ4_TARGET lz4::lz4)
else()
    ...
    if(TARGET PkgConfig::LZ4)
        set(BITCOINII_LZ4_TARGET PkgConfig::LZ4)
    else()
        ...
        add_library(bitcoinII_lz4_native UNKNOWN IMPORTED GLOBAL)

        set_target_properties(bitcoinII_lz4_native PROPERTIES
            IMPORTED_LOCATION "${LZ4_LIBRARY}"
            INTERFACE_INCLUDE_DIRECTORIES "${LZ4_INCLUDE_DIR}"
        )

        set(BITCOINII_LZ4_TARGET bitcoinII_lz4_native)
    endif()
endif()
...
if(NOT TARGET lz4::lz4)
    ...
    set_target_properties(lz4::lz4 PROPERTIES
        INTERFACE_LINK_LIBRARIES "${BITCOINII_LZ4_TARGET}"
    )
endif()
...
if(TARGET zstd::libzstd_static)
    set(BITCOINII_ZSTD_TARGET zstd::libzstd_static)
elseif(TARGET zstd::libzstd_shared)
    set(BITCOINII_ZSTD_TARGET zstd::libzstd_shared)
elseif(TARGET zstd::zstd)
    set(BITCOINII_ZSTD_TARGET zstd::zstd)
else()
    find_package(PkgConfig QUIET)
    ...
    if(TARGET PkgConfig::ZSTD)
        set(BITCOINII_ZSTD_TARGET PkgConfig::ZSTD)
    else()
        ...
        add_library(bitcoinII_zstd_native UNKNOWN IMPORTED GLOBAL)

        set_target_properties(bitcoinII_zstd_native PROPERTIES
            IMPORTED_LOCATION "${ZSTD_LIBRARY}"
            INTERFACE_INCLUDE_DIRECTORIES "${ZSTD_INCLUDE_DIR}"
        )

        set(BITCOINII_ZSTD_TARGET bitcoinII_zstd_native)
    endif()
endif()
...
if(NOT TARGET zstd::zstd)
    ...
    set_target_properties(zstd::zstd PROPERTIES
        INTERFACE_LINK_LIBRARIES "${BITCOINII_ZSTD_TARGET}"
    )
endif()
...
add_library(bitcoinII_rocksdb INTERFACE)

target_link_libraries(bitcoinII_rocksdb
    INTERFACE
        RocksDB::rocksdb
        zstd::zstd
        Threads::Threads
