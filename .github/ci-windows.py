...
def check_manifests(ci_type):
    ...
    skips = {  # Skip as they currently do not have manifests
        "bitcoinII-fuzz.exe",
        "bench_bitcoinII.exe",
        "test_bitcoinII-qt.exe",
        "bitcoinII-chainstate.exe",
    }
...
def run_tests(ci_type):
    ...
    if ci_type == "standard":
        ...
        test_envs = {
            "BITCOINII_BIN": "bitcoinII.exe",
            "BITCOINIID": "bitcoinII-d.exe",
            "BITCOINIICLI": "bitcoinII-cli.exe",
            "BITCOINII_BENCH": "bench_bitcoinII.exe",
            "BITCOINIITX": "bitcoinII-tx.exe",
            "BITCOINIIUTIL": "bitcoinII-util.exe",
            "BITCOINIIWALLET": "bitcoinII-wallet.exe",
            "BITCOINIICHAINSTATE": "bitcoinII-chainstate.exe",
        }
