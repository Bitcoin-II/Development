...
BitcoinII Core v27.0 Release binary and a BitcoinII 31.1.1 Release binary:
...
nearly simulatenously, within 5 seconds of each other. The BitcoinII Core v27.0 node, and one BitcoinII 31.1.1 node maintain
optional blockfilter, coinstats, and txindex databases. One BitcoinII 31.1.1 node maintains only the standard blockchain index:
...
======================================================================================================================
BITCOINII NODE STORAGE AUDIT
======================================================================================================================
Data directory:               BitcoinII Core v27.0 Data Directory
Software profile:             BitcoinII Core v27.0
...
NOTE: BitcoinII Core v27.0 uses LevelDB for database-backed chainstate/index data.
...
BITCOINII NODE STORAGE AUDIT
======================================================================================================================
Data directory:               BitcoinII v31.1.1 Data Directory
Software profile:             BitcoinII v31.1.1
...
NOTE: BitcoinII v31.1.1 uses RocksDB for database-backed chainstate/index data. Its blk*.dat flat files can store individual block payloads as ZSTD-compressed records, with raw fallback when compression is not beneficial.
...
Summary:
BitcoinII Core v27 blk*.dat:        707.755 GiB
BitcoinII indexed blk*.dat:    536.429 GiB
Difference:                       ~171.326 GiB on disk footprint savings.

Optional indexes
Core v27:        79.813 GiB
BitcoinII:    70.606 GiB
Saved:            9.207 GiB
Reduction:       ~11.54%
...
Two independent machines running BitcoinII Rocks v31.1.1 maintain databases that match byte for byte:
961,497 records
