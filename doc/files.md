...
| bin/bitcoinIId                                               | BitcoinII node and wallet daemon                                              |
...
| libexec/bitcoinII-node                                       | IPC-enabled alternative to `bitcoinIId`                                       |
| libexec/test_bitcoinII                                       | Unit test binary                                                            |
| *libexec/test_bitcoinII-qt*                                  | GUI-specific unit tests                                                     |
| share/man/man1/                                            | Man pages for command-line tools like `bitcoinII-cli`, `bitcoinIId`, and others |
