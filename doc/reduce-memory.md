...
If this becomes continuous ("thrashing"), `bitcoinIId` can slow to a crawl, especially during initial sync or reindex.

If you see sustained swap I/O while `bitcoinIId` runs, restart with a lower `-dbcache`.
